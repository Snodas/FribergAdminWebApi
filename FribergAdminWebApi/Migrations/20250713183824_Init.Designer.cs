...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FribergAdminWebApi.Data.ApiUser", b =>
                {
            ...
            modelBuilder.Entity("FribergAdminWebApi.Models.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FribergAdminWebApi.Models.WorkEntry", b =>
                {
                    ...
                    b.Property<decimal>("HourlyRateAtTimeOfWork")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("FribergAdminWebApi.Models.Admin", b =>
                {
                    b.HasOne("FribergAdminWebApi.Data.ApiUser", "ApiUser")
                        .WithOne("Admin")
                        .HasForeignKey("FribergAdminWebApi.Models.Admin", "ApiUserId")
            ...
            modelBuilder.Entity("FribergAdminWebApi.Models.Employee", b =>
                {
                    b.HasOne("FribergAdminWebApi.Data.ApiUser", "ApiUser")
                        .WithOne("Employee")
                        .HasForeignKey("FribergAdminWebApi.Models.Employee", "ApiUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FribergAdminWebApi.Data.ApiUser", null)
                        .WithMany()
